...
class TGN(torch.nn.Module):
  def __init__(self, neighbor_finder, node_features, edge_features, device, n_layers=2,
    ...
    def compute_temporal_embedding(self, source_nodes, destination_nodes, negative_nodes, edge_times,
                                edge_idx, n_neighbors=20):
        ...
        node_embedding = self.embeddings_module.compute_embedding(memory=memory, 
                                                                source_nodes=nodes,
        ...
        if self.use_memory:
            if self.memory_update_at_start:
                ...
                elf.memory.clear_messages(positives)

            unique_sources, source_id_to_messages = self.get_raw_messages(source_nodes, source_node_embedding,
                                                    destination_nodes, destination_node_embedding, edge_times, edge_idx)
