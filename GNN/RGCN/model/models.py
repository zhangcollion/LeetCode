...
class RGCN(Module):
    def __init__(self, i_dim, h_dim, drop_prob, support, num_bases, featureless=True):
        super(RGCN, self).__init__()
        self.drop_prob = drop_prob
        self.gc1 = RGCLayer(i_dim, h_dim, support, num_bases, featureless, drop_prob)
        self.gc2 = RGCLayer(h_dim, h_dim, support, num_bases, False, drop_prob)
